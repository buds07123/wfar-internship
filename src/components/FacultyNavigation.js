...
// import img from '/emp_picture-1650718393447.jpg'
...
const FacultyNavigation = () => {
    ...
    const [isSideClicked, setSideClicked] = useState("home");
    ...
    return (
        <>
                <Helmet>
                    <script src="../js/custom.min.js" type="text/javascript" />
                </Helmet>
                {/* Top Header */}
                <div className="nav-header">
                    <NavLink to="/Faculty" className="brand-logo">
                ...
                <div className="deznav">
                    <div className="deznav-scroll">
                        <div className="main-profile">
                            ...
                            <h5 className="name"><span className="font-w400">Hello,</span> {empData.fname}</h5>
                        </div>
                        <ul className="metismenu" id="menu">
                            ...
                            >
                                ...
                                >
                                    <i className="flaticon-141-home"></i>
                            ...
                            <li className="nav-label">WFAR</li>
                            <li
                                className={
                                    isSideClicked === "submissions" ? "mm-active" : ""
                                }
                            >
                                <NavLink to="/FacultyOwnSubmissions"
                                    className="ai-icon"
                                    aria-expanded="false"
                                    onClick={
