    ...
    return (
        <>
            ...
            <div className="nav-header">
                <NavLink to="/ACDH" className="brand-logo">
                    ...
                    <ul className="metismenu" id="menu">
                        ...
                        >
                            ...
                            >
                                ...
                                <span class="nav-text">Handle Faculty</span>
                            </NavLink>
                        </li>
                        <li
                            className={
                        ...
                        >
                            ...
                            >
                                ...
                                <span class="nav-text">My WFAR Submissions</span>
                            </NavLink>
                        </li>
                        <li className="nav-label first">View all</li>
                        <li
                            className={
                                isSideClicked === "WFAR" ? "mm-active" : ""
                            }
                        >
                            <NavLink to="/ACDHAllWfarSubmissions"
                                className="ai-icon"
                                aria-expanded="false"
                                onClick={
                                    () => { setSideClicked("WFAR") }
